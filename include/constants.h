...
//长宽比范围
static const float kLedMinHeightVSWidth = 3.0;
static const float kLedMaxHeightVSWidth = 12.0;

const int kArmorTypeThreshold = 5;
=======
static const float kLedMaxSlope = 1.732;
//长宽比范围
static const float kLedMinHeightVSWidth = 1.0;
static const float kLedMaxHeightVSWidth = 14.0;

const double kArmorTypeThreshold = 0.278;
>>>>>>> 这一版增加了数字识别，但效果不太理想
//装甲板确定
//长度之比最大 0~x
...
static const float kRealLargeArmorHeight = 5.5;

//小装甲实际大小
static const float kRealSmallArmorWidth = 13.5;
static const float kRealSmallArmorHeight = 5.5;
...
<<<<<<< HEAD
static const cv::Mat caremaMatrix_shoot = (
        cv::Mat_<float>(3, 3) << 637.367993014067,      -1.29217557050940,              304.667302805781,
                                 0,                     636.724215203934,              258.460402402052,
=======
//static const cv::Mat caremaMatrix_shoot = (
//        cv::Mat_<float>(3, 3) << 637.367993014067,      -1.29217557050940,              304.667302805781,
//                                 0,                     636.724215203934,              258.460402402052,
...
<<<<<<< HEAD
        cv::Mat_<float>(1, 5) << -0.249322829161717,
                                 ...
                                 -1.09855488382837);
=======
        cv::Mat_<float>(1, 5) << -0.249412251226009,
                                 0.827020257428710,
                                 -0.00443104188635004,
                                 -0.00203469041327686,
                                 -2.90434972150462);
